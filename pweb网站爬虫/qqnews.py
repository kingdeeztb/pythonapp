...
news_yaowen = soup.select("ul.yw-list>li")
news_title = soup.select(
    "ul.zkList.zkulist.clearfix.minHeight>li.clearfix>div.timeDate.fl>p>span")

print(news_yaowen)
# print(news_title)
with open('qq新闻网.txt', 'a') as file_handle:   # .txt可以不自己新建,代码会自动新建
    file_handle.write(str(news_yaowen))     # 写入
